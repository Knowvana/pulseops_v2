// ============================================================================
// vite.module.config.js — PulseOps V2 Module Build Configuration
//
...
//
// DUAL-MODE LOADING:
//   DEV:  moduleRegistry.js loads /src/modules/<id>/manifest.jsx directly
...
// VITE_MODULE_ENTRY is set by build-module.js for new layout (modules/<id>/ui/manifest.jsx)
// Falls back to legacy layout (src/modules/<id>/manifest.jsx)
const MODULE_ENTRY = process.env.VITE_MODULE_ENTRY
  || path.resolve(__dirname, `modules/${MODULE_ID}/ui/manifest.jsx`);
