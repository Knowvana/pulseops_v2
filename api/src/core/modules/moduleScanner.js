...
// dist-modules/ lives inside api/ (3 levels up from src/core/modules/)
// This ensures Node's module resolution finds express in api/node_modules/
const API_ROOT = path.resolve(__dirname, '../../..');
const DEFAULT_MODULES_DIR = path.resolve(API_ROOT, 'dist-modules');
